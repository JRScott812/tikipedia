...
state.captionSizeInput = document.getElementById("setting-captionSize");
state.captionStrokeInput = document.getElementById("setting-captionStroke");
...
state.feedHeader = document.querySelector(".feedHeader");
state.feedSearch = document.querySelector(".feedSearch");
state.feedSearchToggle = document.querySelector(".feedSearchToggle");
state.feedSearchPanel = document.getElementById("feedSearchPanel");
state.feedSearchInput = document.getElementById("feedSearchInput");
state.feedSearchResults = document.getElementById("feedSearchResults");
state.feedSearchStatus = document.getElementById("feedSearchStatus");
